...
def corrige(uploaded_file):
    ...
    combined_rules = """Considerando as correções de cada competência:
    ...
    Estruture as correções por cada competência, Retomando os pontos indicados. Calcule a nota final da redação do usuário.
    """
